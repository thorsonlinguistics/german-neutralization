...
cmd = ['gzcat ', alifile, ' | /projects/speech/sys/kaldi-master/src/bin/ali-to-pdf ', model, ' ark,t:- ark,t:- >', pdf_ali];
system(cmd);
...
cmd = ['gzcat ', alifile, ' | /projects/speech/sys/kaldi-master/src/bin/ali-to-phones  --per-frame ', model, ' ark,t:- ark,t:- >', phone_ali];
disp(cmd);
system(cmd);
...
% --write-lengths
cmd = ['gzcat ', alifile, ' | /projects/speech/sys/kaldi-master/src/bin/ali-to-phones --write-lengths ', model, ' ark,t:- ark,t:- >', phone_seq];
disp(cmd);
system(cmd);
