...
switch name
   case 'vm1_tri'
     alifile = '/projects/speech/sys/kaldi-trunk/egs/VM1/c1-jnc76/experiment/exp/tri2b_ali/ali.1.gz';
     wavscp = '/projects/speech/sys/kaldi-trunk/egs/VM1/c1-jnc76/experiment/data/train_unambiguous/wav.scp';
     model = '/projects/speech/sys/kaldi-trunk/egs/VM1/c1-jnc76/experiment/exp/tri2b_ali/final.mdl';
     phones = '/projects/speech/sys/kaldi-trunk/egs/VM1/c1-jnc76/experiment/data/lang/phones.txt';
     transcript = '/projects/speech/sys/kaldi-trunk/egs/VM1/c1-jnc76/experiment/data/train_ambiguous/text';
     datbase = 'matlab-mat/VM1_tri2b';
     audiodir = 'matlab-wav/VM1_tri2b';
   case 'vm1a'
     alifile = '/projects/speech/sys/kaldi-trunk/egs/vm1_copy/exp/mono_ali/ali.1.gz';
     wavscp = '/projects/speech/sys/kaldi-trunk/egs/vm1_copy/data/train/wav.scp';
     model = '/projects/speech/sys/kaldi-trunk/egs/vm1_copy/exp/mono_ali/final.mdl';
     phones = '/projects/speech/sys/kaldi-trunk/egs/vm1_copy/data/lang/phones.txt';
     transcript = '/projects/speech/sys/kaldi-trunk/egs/vm1_copy/data/train/text';
     datbase = 'matlab-mat/vm1a';
     audiodir = 'matlab-wav/vm1a';
   case 'bp3'
